...
class UrgentAnnouncement extends Component {
  render() {
    return (
      <div className="w-full flex justify-center bg-white">
        <div className="border-cb-grey-border border-b flex flex-col sm:flex-row w-3/5 pb-6 sm:pb-8 mt-10 font-cu-heading">
          ...
          <div className="w-full sm:w-1/2 sm:pl-8 flex items-end">
  ...
  contentDate = (date, month) => {
    return (
        <div className="mr-10 text-right text-cb-red w-1/2">
