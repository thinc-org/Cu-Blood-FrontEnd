                ...
                <div className="layout-wide">
                    ...
                    <div className="bg-white py-10 flex flex-col px-10 rounded-lg">
                        ...
                        <div className="flex justify-between mt-8">
                            {this.eventDate(`10 มกราคม - 20 มีนาคม`, `วันลงทะเบียน`)}
                            {this.eventDate(`21 มีนาคม - 30 มีนาคม`, `วันบริจาคโลหิต`, `text-right`)}
                        </div>
                    </div>
                </div>
            </div>
    ...
    content = (thaiPlace, engPlace, urlLocation, divClass=``) => {
        return(
            <div className={`flex items-center justify-between ${divClass}`}>
                <div className="flex flex-col font-cu-heading">
                ...
                <div className="flex font-cu-body items-center">
                    <a href={`${urlLocation}`} target="_blank" rel="noopener noreferrer" className="text-base mr-8" style={{color: "#58595b"}}>ดูแผนที่</a>
