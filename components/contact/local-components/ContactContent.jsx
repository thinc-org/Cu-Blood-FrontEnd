        ...
        return(
            <div className="layout-wide py-10 flex flex-col sm:flex-row font-cu-heading text-lg items-center" style={{maxWidth: "40rem"}}>
                <div className="w-full sm:w-1/2 flex items-center pb-6 sm:pb-0 sm:pr-6">
                    ...
                    <div>View on <a href="https://www.google.com/maps/search/?api=1&query=13.7367861%2C100.5321102&query_place_id=ChIJS2-cD9We4jAReELREIa4HPI" target="_blank" className="font-semibold no-underline text-cb-red">Google Maps</a></div>
                </div>
