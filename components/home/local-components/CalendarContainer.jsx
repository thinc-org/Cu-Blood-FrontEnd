        ...
        return (
            <div className="bg-cb-pink-light ">
                <div className="layout-wide">
                    ...
                    <MinorEvent title={eventTitle[1]} location={majorLocation[1]} startDate={startDate[1]} endDate={endDate[1]} />
                    <MinorEvent title={eventTitle[2]} location={majorLocation[2]} startDate={startDate[2]} endDate={endDate[2]} />
                    <MinorEvent title={eventTitle[3]} location={majorLocation[3]} startDate={startDate[3]} endDate={endDate[3]} />
                    <MinorEvent title={eventTitle[4]} location={majorLocation[4]} startDate={startDate[4]} endDate={endDate[4]} hasLineBreak={false} />
                </div>
            </div>
        );
    }
...
const MinorEvent = (props) => {
    const { title, hasLineBreak, startDate, endDate, location } = props;
