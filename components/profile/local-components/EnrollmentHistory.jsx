      ...
      return (
        <div className="bg-cb-grey-lighter pb-10">
          <div className="layout-wide">
            <Header
              english={t("enrollmentHistorySmallHeader")}
              thai={t("enrollmentHistoryBigHeader")}
            ...
            <div className="mb-8">
              <Card>
                <Detail
                  bigText="ขณะนี้ข้อมูลมีปัญหา โปรดลองใหม่อีกครั้ง"
                  smallText="Error in retrieving information, please try again later"
                />
              </Card>
            </div>
          </div>
        ...
        <div className="bg-cb-grey-lighter pb-10">
          <div className="layout-wide">
            ...
            <div className="mb-8">
              <Card>
                <Detail
                  bigText="ไม่มีประวัติการเข้าร่วมกิจกรรม"
                  smallText="No enrollment history is available"
                />
              </Card>
            </div>
          </div>
      ...
      return (
        <div className="mb-8">
          <Card>
            <Detail
              bigText={projectName}
              smallText={t("enrollmentHistoryNoDonation")}
            />
          </Card>
        </div>
      );
    ...
    return (
      <div className="mb-8">
        <Card>
          <Detail
            bigText={projectName}
            smallText={`${t("enrollmentHistoryDonation")}: ${timeSlot}`}
          />
        </Card>
      </div>
    );
